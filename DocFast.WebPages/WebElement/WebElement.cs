...

{
    public partial class WebElement : ICloneable
    {
        ...
        private IWebElement FindSingleIWebElement()
        {
            ...
            if (!elements.Any()) throw new WebElementException("");
        ...
        private WebElementException WebElementNotFoundException
        {
            get
            {
                CheckConnectionFailure();

                return new WebElementException(string.Format("Can't find single element with given search criteria: {0}.",
