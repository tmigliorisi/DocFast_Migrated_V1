...
namespace SeleNUnit.WebObjects.WebElement
{
    ...
    public partial class WebElement
    {
        ...
        public WebElement ByLinkText(string text)
        {
            var selector = By.LinkText(string.Format("//*[text()=\"{0}\"]", text));

            //_firstSelector = _firstSelector ?? selector;
            //_textSearchData = new TextSearchData { Text = text };

            return this;
        }

      
        public WebElement ByAttribute(string tagAttribute, string attributeValue, bool exactMatch = true)
        {
